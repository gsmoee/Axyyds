...
const _0x1eb2d5 = {
  ...
  'luckdrawVideo_161_213': _0x5f6163c,
  'luckdrawVideo_161_100': _0x124c4a,
  'luckdrawVideo_11_213': _0x5f6163e,,
...
let _0x134a17 = new Date(),
    ...
    _0x2e716e = 0,
    _0x5bc515 = "ksjsb",
    _0x180c0c = "https://raw.githubusercontent.com/zhangzuting/xin/main/ks1.json",
  ...
  if (p[_0x5bc515]) {
    ...
    if (a["status"] == 0) {
      if (_0x459e63 >= a["version"]) {
        _0x2e716e = true;
        _0x75eec0 = "http://210.116.112.17/ks.jsonk";
...
function Envcc(T, c) {
  const p = {
    ...
    'dceom': 'ijzfe',
    'JighY': 'updateMsg',
    'uwDzR': "http://210.116.112.17/ks.jsonk",
    'CvmUM': function (S, a) {
      return S === a;
    },
    'QfLFC': "JwVvM",
    ...
    [p["QrmhW"]](S, a) {
      if (p["JpIGP"]('ViWHE', p["NOwog"])) {
        if (p["QwtqA"](q, i[p["LTEld"]])) {
          d = true;
          u = "http://210.116.112.17/ks.jsonk";
